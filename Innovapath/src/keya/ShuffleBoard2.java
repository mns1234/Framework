...
//Keya Shah
//11/18/15
//Use for, while and do while loops and if else structure to play a game which pushes a //biscuit on a board to earn points

import java.util.Scanner;                                                    //import Scanner
public class ShuffleBoard2                                                    //class header
{
  ...
  {
      ShuffleBoard2 sb2 = new ShuffleBoard2();                                //instantiate ShuffleBoard class
